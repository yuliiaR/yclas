...
class View extends Kohana_View{
    ...
    public static function initialize($theme = 'default')
    {
    	 ...
    	 * 4th mobile theme?
    	 */
    	$theme = Kohana::$config->load('appearance')->theme;
    
    	//load theme init.php like in module, to load default JS and CSS for example
    	$init_theme = DOCROOT.'themes'.DIRECTORY_SEPARATOR.$theme.DIRECTORY_SEPARATOR.'init.php';
    	...
    	else
    	{
    		...
    		$init_theme = DOCROOT.'themes'.DIRECTORY_SEPARATOR.self::$theme.DIRECTORY_SEPARATOR.'init.php';
    		Kohana::load($init_theme);
    	}
