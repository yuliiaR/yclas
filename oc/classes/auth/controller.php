		...
		if($this->auto_render===TRUE)
		{
            ...
            if (Core::get('rel')!='ajax')
            {
    			...
    			else
    			{
    	            ...
    	            if (Theme::get('admin_theme')!='bootstrap' AND Theme::get('admin_theme')!='')
    	            {
    	                $theme_css = array('//netdna.bootstrapcdn.com/bootswatch/3.3.4/'.Theme::get('admin_theme').'/bootstrap.min.css' => 'screen',);
    	            }
    	            //default theme
    	            else
    	            {
    	                $theme_css = array('//netdna.bootstrapcdn.com/bootswatch/3.3.4/paper/bootstrap.min.css' => 'screen');
    	            }
