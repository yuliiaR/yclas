	...
	<div id="error4ac2453378034environment" class="content collapsed">
		...
		<div id="error4ac2453378034environment_server" class="collapsed">
			...
			<table cellspacing="0">
					...
					<td><pre><small>string</small><span>(110)</span> "&lt;address&gt;Apache/2.3.01 (Ubuntu) PHP/5.2.6-3ubuntu4.2 with Suhosin-Patch Server at localhost Port 80&lt;/address&gt;
"</pre></td>

				</tr>
								<tr>
					<td><code>SERVER_SOFTWARE</code></td>
					<td><pre><small>string</small><span>(62)</span> "Apache/2.3.01 (Ubuntu) PHP/5.2.6-3ubuntu4.2 with Suhosin-Patch"</pre></td>
				</tr>
								<tr>
