...
(0, 'Advertisement is created on [SITE.NAME]!', 'ads.user_check', 'Hello [USER.NAME],\n\n Advertisement is created under your account [USER.NAME]! You can visit this link see advertisement [URL.AD]\n\n And if you are not responsible for creating this advertisement, please contact us here regarding this inconvenience [URL.CONTACT].\n\n, '".$_POST['ADMIN_EMAIL']."', 'email', 1),
...
('advertisement', 'featured_timer', '5'),
('advertisement', 'expire_date', '5'),
