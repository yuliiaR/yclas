...
('fr_FR', 'Félicitations! Votre annonce a été créée sur [SITE.NAME]!', 'ads-confirm', 'Bienvenu [USER.NAME],<br /><br />\n<br /><br />\nMerci d''avoir créer une anonnce sur [SITE.NAME]! <br /><br />\n<br /><br />\nVeuillez cliquer sur ce lien [URL.QL] pour la confirmer.<br /><br />\n<br /><br />\nCordialement!', '".core::request('ADMIN_EMAIL')."', 'email', 1),
('fr_FR', 'Félicitations! Votre annonce a été créée sur [SITE.NAME]!', 'ads-notify', 'Bonjour [USER.NAME],<br /><br />\n<br /><br />\nMerci d''avoir créer une anonnce sur [SITE.NAME]! <br /><br />\n<br /><br />\nVous pouvez modifier votre annonce ici [URL.QL].<br /><br />\n<br /><br />\nVotre annonce est en attente de publication, elle doit être validée par l''administrateur.<br /><br />\n<br /><br />\nNous sommes désolés pour la gène occasionnée. Nous allons l''examiner dès que possible. <br /><br />\n<br /><br />\nCordialement!', '".core::request('ADMIN_EMAIL')."', 'email', 1),
('fr_FR', '[EMAIL.SENDER] souhaite vous contacter!', 'contact-admin', 'Bonjour Administrateur,<br /><br />\n<br /><br />\n[EMAIL.SENDER]: [EMAIL.FROM], have a message for you:<br /><br />\n<br /><br />\n[EMAIL.BODY] <br /><br />\n<br /><br />\nCordialement!', '".core::request('ADMIN_EMAIL')."', 'email', 1),
('fr_FR', 'Votre annonce sur [SITE.NAME], a été activée!', 'ads-activated', 'Bonjour [USER.OWNER],<br /><br />\n<br /><br />\nNous vous informons que votre annonce [URL.QL] a été activée!<br /><br />\nElle est désormais visible par tous. <br /><br />\n<br /><br />\nEn espérant ne vous avoir pas fait attendre trop longtemps. <br /><br />\n<br /><br />\nCordialement!', '".core::request('ADMIN_EMAIL')."', 'email', 1),
('fr_FR', 'Bonjour [USER.NAME]!', 'user-new', 'Bienvenu sur [SITE.NAME]. <br /><br />\n<br /><br />\nNous sommes ravis de votre participation,<br /><br />\nVous pouvez vous connecter avec votre email: [USER.EMAIL], <br /><br />\nvotre mot de passe: [USER.PWD]. <br /><br />\n<br /><br />\nLe mot de passe est auto-généré, pour le changer cliquez ce lien [URL.PWCH]. <br /><br />\n<br /><br />\nMerci de votre confiance! <br /><br />\n<br /><br />\nCordialement!', '".core::request('ADMIN_EMAIL')."', 'email', 1),
('fr_FR', 'Bonjour [USER.NAME]!', 'user-contact', 'Vous avez été contacté au sujet de votre annonce. <br /><br />\nL''utilisateur [EMAIL.SENDER] [EMAIL.FROM], a un message pour vous:<br /><br />\n[EMAIL.BODY]. <br /><br />\n<br /><br />\nCordialement!', '".core::request('ADMIN_EMAIL')."', 'email', 1),
...
('fr_FR', 'Bienvenu sur [SITE.NAME]!', 'auth-register', 'Bienvenu [USER.NAME],<br /><br />\n<br /><br />\nNous sommes ravis de votre participation! [URL.QL]<br /><br />\nRappelez-vous vos informations d''utilisateur:<br /><br />\nEmail: [USER.EMAIL]<br /><br />\nMot de passe: [USER.PWD]<br /><br />\n<br /><br />\nNous n''avons plus votre mot de passe original.<br /><br />\n<br /><br />\nCordialement!', '".core::request('ADMIN_EMAIL')."', 'email', 1),
('fr_FR', 'Bonjour [USER.NAME]!', 'user-profile-contact', 'Utilisateur [Email.SENDER] [EMAIL.From], a un message pour vous: [EMAIL.SUBJECT] [EMAIL.BODY]. Cordialement,', '".core::request('ADMIN_EMAIL')."', 'email', 1),
('fr_FR', 'L''annonce `[AD.NAME]` est créé sur [SITE.NAME]!', 'ads-user-check', 'Bonjour [USER.NAME], l''annonce est créé sous votre compte [USER.NAME]! Vous pouvez visiter ce lien pour voir l''annonce [URL.AD] Si vous n''êtes pas responsable de la création de cette annonce, cliquez sur le lien pour nous contacter [URL.CONTACT].', '".core::request('ADMIN_EMAIL')."', 'email', 1),
('fr_FR', 'L''annonce `[AD.TITLE]` est créé sur [SITE.NAME]!', 'ads-subscribers', 'Bonjour, Vous êtes peut être intéressé par celui-ci! Vous pouvez visiter ce lien pour voir l''annonce [URL.AD]', '".core::request('ADMIN_EMAIL')."', 'email', 1),
('fr_FR', 'L''annonce `[AD.TITLE]` est créé sur [SITE.NAME]!', 'ads-to-admin', 'Cliquez ici pour visiter [URL.AD]', '".core::request('ADMIN_EMAIL')."', 'email', 1),
('fr_FR', 'L''annonce `[AD.TITLE]` est vendu sur [SITE.NAME]!', 'ads-sold', 'Numéro de commande: [ORDER.ID] ID de produit: [PRODUCT.ID] Veuillez svp vérifier votre compte pour le paiement entrant. Cliquez ici pour visiter [URL.AD]', '".core::request('ADMIN_EMAIL')."', 'email', 1),
('fr_FR', 'L''annonce `[AD.TITLE]` est en rupture de stock sur [SITE.NAME]!', 'out-of-stock', 'Bonjour [USER.NAME], tandis que votre annonce est en rupture de stock, il est indisponible pour les autres de le voir. Si vous souhaitez augmenter celui-ci et l''activer, veuillez vous plaît cliquer sur lien suivant [URL.EDIT]. Cordialement!', '".core::request('ADMIN_EMAIL')."', 'email', 1),
('fr_FR', 'Reçu pour [ORDER.DESC] # [ORDER.ID]', 'new-order', 'Bonjour [USER.NAME], Merci pour l''achat [ORDER.DESC]. Veuillez svp compléter le paiement ici [URL.CHECKOUT]', '".core::request('ADMIN_EMAIL')."', 'email', 1),
('fr_FR', 'Votre annonce [AD.NAME] a été expiré', 'ad-expired', 'Bonjour [USER.NAME], Votre annonce [AD.NAME] a été expiré. Veuillez svp vérifier votre annonce ici [URL.EDITAD]', '".core::request('ADMIN_EMAIL')."', 'email', 1),
('fr_FR', 'L''annonce `[AD.TITLE]` est acheté sur [SITE.NAME]!', 'ads-purchased', 'Numéro de commande: [ORDER.ID] ID de produit: [PRODUCT.ID] Pour tout inconvénient veuillez vous plaît contacter l''administrateur de [SITE.NAME] Cliquez ici pour visiter [URL.AD]', '".core::request('ADMIN_EMAIL')."', 'email', 1),
('fr_FR', 'Mot de passe modifié [SITE.NAME]', 'password-changed', 'Bonjour [USER.NAME], Votre mot de passe a été changé. Ce sont maintenant vos détails d''utilisateur: Email: [USER.EMAIL] Mot de passe: [USER.PWD] Nous ne disposons plus de votre mot de passe original. Cordialement!', '".core::request('ADMIN_EMAIL')."', 'email', 1),
('fr_FR', 'Votre annonce [AD.NAME] va expirer', 'ad-to-expire', 'Bonjour [USER.NAME], Votre annonce [AD.NAME] va bientôt expirer Veuillez svp vérifier votre annonce ici [URL.EDITAD]', '".core::request('ADMIN_EMAIL')."', 'email', 1),
('fr_FR', 'Nouvelle réponse: [TITRE]', 'messaging-reply', '[URL.QL]\r\n\r\n[DESCRIPTION]', '".core::request('ADMIN_EMAIL')."', 'email', 1),
('fr_FR', '[FROM.NAME] vous a envoyé un message direct', 'messaging-user-contact', 'Bonjour [TO.NAME], [FROM.NAME] ont un message pour vous: [description] [URL.QL] Cordialement!', '".core::request('ADMIN_EMAIL')."', 'email', 1),
('fr_FR', 'Nouveau commentaire pour [AD.TITLE] [RATE]', 'ad-review', '[URL.QL]\r\n\r\n[RATE]\r\n\r\n[DESCRIPTION]', '".core::request('ADMIN_EMAIL')."', 'email', 1),
