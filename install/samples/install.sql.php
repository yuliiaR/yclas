...
mysql_query("CREATE TABLE IF NOT EXISTS `".core::request('TABLE_PREFIX')."locations` (
...
mysql_query("CREATE TABLE IF NOT EXISTS `".core::request('TABLE_PREFIX')."ads` (
...
mysql_query("CREATE TABLE IF NOT EXISTS `".core::request('TABLE_PREFIX')."subscribers` (
 ...
 */
mysql_query("INSERT INTO `".core::request('TABLE_PREFIX')."content` (`id_content`, `locale`, `order`, `title`, `seotitle`, `description`, `from_email`, `created`, `type`, `status`)
    VALUES
...
//base location
mysql_query("INSERT INTO `".core::request('TABLE_PREFIX')."locations` 
...
{
    //sample catpegories
    mysql_query("INSERT INTO `".core::request('TABLE_PREFIX')."categories` (`id_category`, `name`, `order`, `created`, `id_category_parent`, `parent_deep`, `seoname`, `description`, `price`) VALUES
