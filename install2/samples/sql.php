...
mysql_query('SET NAMES '.installl::request('DB_CHARSET'));
mysql_query("SET SQL_MODE='NO_AUTO_VALUE_ON_ZERO';");

mysql_query("CREATE TABLE IF NOT EXISTS `".installl::request('TABLE_PREFIX')."roles` (
  `id_role` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(45) DEFAULT NULL,
  `description` varchar(245) DEFAULT NULL,
  `date_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_role`),
  UNIQUE KEY `".installl::request('TABLE_PREFIX')."roles_UK_name` (`name`)
) ENGINE=MyISAM DEFAULT CHARSET=".installl::request('DB_CHARSET').";");


mysql_query("CREATE TABLE IF NOT EXISTS `".installl::request('TABLE_PREFIX')."access` (
...
mysql_query("CREATE TABLE IF NOT EXISTS  `".installl::request('TABLE_PREFIX')."users` (
  ...
  PRIMARY KEY (`id_user`),
  UNIQUE KEY `".installl::request('TABLE_PREFIX')."users_UK_email` (`email`),
  UNIQUE KEY `".installl::request('TABLE_PREFIX')."users_UK_token` (`token`),
  UNIQUE KEY `".installl::request('TABLE_PREFIX')."users_UK_seoname` (`seoname`),
  UNIQUE KEY `".installl::request('TABLE_PREFIX')."users_UK_provider_AND_uid` (`hybridauth_provider_name`,`hybridauth_provider_uid`)
) ENGINE=InnoDB DEFAULT CHARSET=".installl::request('DB_CHARSET').";");


mysql_query("CREATE TABLE IF NOT EXISTS  `".installl::request('TABLE_PREFIX')."categories` (
  ...
  UNIQUE KEY `".installl::request('TABLE_PREFIX')."categories_IK_seo_name` (`seoname`)
) ENGINE=InnoDB DEFAULT CHARSET=".installl::request('DB_CHARSET').";");


mysql_query("CREATE TABLE IF NOT EXISTS `".installl::request('TABLE_PREFIX')."locations` (
  ...
  UNIQUE KEY `".installl::request('TABLE_PREFIX')."categories_UK_seoname` (`seoname`)
) ENGINE=InnoDB DEFAULT CHARSET=".installl::request('DB_CHARSET').";");


mysql_query("CREATE TABLE IF NOT EXISTS `".installl::request('TABLE_PREFIX')."ads` (
  ...
  KEY `".installl::request('TABLE_PREFIX')."ads_IK_id_user` (`id_user`),
  KEY `".installl::request('TABLE_PREFIX')."ads_IK_id_category` (`id_category`),
  KEY `".installl::request('TABLE_PREFIX')."ads_IK_title` (`title`),
  UNIQUE KEY `".installl::request('TABLE_PREFIX')."ads_UK_seotitle` (`seotitle`),
  KEY `".installl::request('TABLE_PREFIX')."ads_IK_status` (`status`),
  CONSTRAINT `".installl::request('TABLE_PREFIX')."ads_FK_id_user_AT_users` FOREIGN KEY (`id_user`) REFERENCES `".installl::request('TABLE_PREFIX')."users` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `".installl::request('TABLE_PREFIX')."ads_FK_id_category_AT_categories` FOREIGN KEY (`id_category`) REFERENCES `".installl::request('TABLE_PREFIX')."categories` (`id_category`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=".installl::request('DB_CHARSET').";");


mysql_query("CREATE TABLE IF NOT EXISTS `".installl::request('TABLE_PREFIX')."visits` (
  ...
  KEY `".installl::request('TABLE_PREFIX')."visits_IK_id_user` (`id_user`),
  KEY `".installl::request('TABLE_PREFIX')."visits_IK_id_ad` (`id_ad`)
) ENGINE=MyISAM DEFAULT CHARSET=".installl::request('DB_CHARSET').";");


mysql_query("CREATE TABLE IF NOT EXISTS `".installl::request('TABLE_PREFIX')."config` ( 
  `group_name` VARCHAR(128)  NOT NULL, 
  `config_key` VARCHAR(128)  NOT NULL, 
  `config_value` TEXT,
   KEY `".installl::request('TABLE_PREFIX')."config_IK_group_name_AND_config_key` (`group_name`,`config_key`)
) ENGINE=MyISAM DEFAULT CHARSET=".installl::request('DB_CHARSET')." ;");


mysql_query("CREATE TABLE IF NOT EXISTS  `".installl::request('TABLE_PREFIX')."orders` (
  ...
  KEY `".installl::request('TABLE_PREFIX')."orders_IK_id_user` (`id_user`),
  KEY `".installl::request('TABLE_PREFIX')."orders_IK_status` (`status`)
)ENGINE=MyISAM DEFAULT CHARSET=".installl::request('DB_CHARSET').";");


mysql_query("CREATE TABLE IF NOT EXISTS `".installl::request('TABLE_PREFIX')."content` (
...
mysql_query("CREATE TABLE IF NOT EXISTS `".installl::request('TABLE_PREFIX')."subscribers` (
...
mysql_query("CREATE TABLE IF NOT EXISTS  `".installl::request('TABLE_PREFIX')."posts` (
...
(0, 'Advertisement `[AD.TITLE]` is created on [SITE.NAME]!', 'ads.to_admin', 'Click here to visit [URL.AD]', '".installl::request('ADMIN_EMAIL')."', 'email', 1),
 ...
 */
$password = hash_hmac('sha256', installl::request('ADMIN_PWD'), $hash_key);
mysql_query("INSERT INTO `".installl::request('TABLE_PREFIX')."users` (`id_user`, `name`, `seoname`, `email`, `password`, `status`, `id_role`) 
VALUES (1, 'admin', 'admin', '".installl::request('ADMIN_EMAIL')."', '$password', 1, 10)");
 ...
 *
 */
mysql_query("INSERT INTO `".installl::request('TABLE_PREFIX')."config` (`group_name`, `config_key`, `config_value`) VALUES
...
('i18n', 'charset', 'utf-8'),
('i18n', 'timezone', '".installl::request('TIMEZONE')."'),
('i18n', 'locale', '".installl::request('LANGUAGE')."'),
...
('general', 'base_url', '".installl::request('SITE_URL')."'),
...
('general', 'site_name', '".installl::request('SITE_NAME')."'),
...
('email', 'notify_email', '".installl::request('ADMIN_EMAIL')."'),
('email', 'smtp_active', 0),
...
//base category
mysql_query("INSERT INTO `".installl::request('TABLE_PREFIX')."categories` 
  (`id_category` ,`name` ,`order` ,`id_category_parent` ,`parent_deep` ,`seoname` ,`description` )
VALUES (1, 'Home category', 0 , 0, 0, 'all', 'root category');");


//base location
mysql_query("INSERT INTO `".installl::request('TABLE_PREFIX')."locations` 
...
//sample values 
if ( install::request('SAMPLE_DB') !== NULL)
{
    //sample catpegories
    mysql_query("INSERT INTO `".installl::request('TABLE_PREFIX')."categories` (`id_category`, `name`, `order`, `created`, `id_category_parent`, `parent_deep`, `seoname`, `description`, `price`) VALUES
