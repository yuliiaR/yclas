...
<form class="well form-horizontal"  method="post" action="<?=Route::url('user',array('directory'=>'user','controller'=>'auth','action'=>'register'))?>">         
          <?=Form::errors()?>
          ...
          <div class="form-actions">
          	<a class="btn"  data-dismiss="modal" data-toggle="modal" title="<?=__('Login')?>" href="<?=Route::url('user',array('directory'=>'user','controller'=>'auth','action'=>'login'))?>#login-modal">
				<i class="icon-user"></i> 
				<?=__('Login')?>
			</a>
