                    ...
                    <?if(core::config('advertisement.price') != FALSE):?>
                        <div class="form-group">
                            <div class="col-sm-8 col-xs-12">
                                ...
                                <div class="input-prepend">
                                    <?= FORM::input('price', html_entity_decode(i18n::money_format($ad->price)), array('placeholder'=>html_entity_decode(i18n::money_format(1)),'class'=>'form-control', 'id' => 'price', 'data-error' => __('Please enter only numbers.')))?>
                                </div>
                            </div>
                        </div>
                    <?endif?>
