<?php defined('SYSPATH') or die('No direct script access.');?>
	...
	<form class="well form-horizontal"  method="post" action="<?=Route::url('oc-panel',array('controller'=>'migration','action'=>'index'))?>">         
          <?=Form::errors()?>        
      ...
      <div class="control-group">
        ...
        <div class="controls">
        <input type="text" name="table_prefix" value="<?=$db_config['table_prefix']?>" class="span3" />
        </div>
      </div>
