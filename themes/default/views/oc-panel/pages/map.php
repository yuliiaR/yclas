  ...
  <form id="addimap" name="addimap" action="<?=URL::base()?><?=Request::current()->uri()?>" method="post">
    <div class="form-horizontal" id="default-settings">
      <div class="form-group">
        <?= FORM::label('map_active', __('Map on homepage'), array('class'=>'control-label col-sm-3', 'for'=>'map_active'))?>
        <div class="col-sm-4">
          <div class="onoffswitch">
            <?= FORM::hidden('map_active', 0);?>
            <?= FORM::checkbox('map_active', 1, (bool) $map_active, array(
                        'placeholder' => "", 
                        'class' => 'onoffswitch-checkbox', 
                        'id' => 'map_active', 
                        'data-original-title'=> __("Map on homepage"),
                        'data-trigger'=>"hover",
                        'data-placement'=>"right",
                        'data-toggle'=>"popover",
                        'data-content'=>__("Disables generated map on homepage"),
                        ))?>
            <?= FORM::label('map_active', "<span class='onoffswitch-inner'></span><span class='onoffswitch-switch'></span>", array('class'=>'onoffswitch-label', 'for'=>'map_active'))?>
          </div>
        </div>
      </div>
      <div class="form-group">
        <label class="control-label col-sm-3" for="bg_color">
          <?=__('Background Color')?>
        </label>
        <div class="col-sm-4">
      ...
      <div class="form-group">
        <label class="control-label col-sm-3" for="border_color">
          <?=__('Map Border Color')?>
        </label>
        <div class="col-sm-4">
      ...
      <div class="form-group">
        <label class="control-label col-sm-3" for="border_stroke">
      ...
      <div class="form-group">
        <label class="control-label col-sm-3" for="ina_color">
      ...
      <div class="form-group">
        <label class="control-label col-sm-3" for="tooltip_color">
      ...
      <div class="form-group">
        <label class="control-label col-sm-3" for="height">
          <?=__('Height (px)')?>
        </label>
        <div class="col-sm-4">
      ...
      <div class="form-group">
        <div class="col-sm-4 col-sm-offset-3">
          <div class="checkbox">
            <label>
              <input name="aspect_ratio" type="checkbox" id="aspratio" onChange="drawVisualization();" value="1" checked>
              <?=__('Keep Aspect Ratio')?>
            </label>
          </div>
        </div>
      </div>
