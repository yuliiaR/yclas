...
<div class="well">
    <?= FORM::open(Route::url('oc-panel',array('controller'=>'settings', 'action'=>'form')), array('class'=>'form-horizontal', 'enctype'=>'multipart/form-data'))?>
        <fieldset>
            ...
            <div class="form-group">
                <?= FORM::label($forms['only_admin_post']['key'], __('Only administrators can publish'), array('class'=>'control-label col-sm-3', 'for'=>$forms['only_admin_post']['key']))?>
                <div class="col-sm-4">
                    <div class="onoffswitch">
