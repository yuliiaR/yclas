...
<div class="row">
    <div class="col-md-8">
	    ...
	    <div class="panel-heading"><?="<a target='_blank' href='http://open-classifieds.com/2015/03/25/how-to-configure-image-settings/'>".__("Image configuration")."</a>"?></div>
            <div class="panel-body">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <?= FORM::label($forms['watermark']['id'], "<a target='_blank' href='http://open-classifieds.com/2013/11/12/how-to-add-a-watermark/'>".__('Watermark')."</a>", array('class'=>'control-label col-sm-4', 'for'=>$forms['watermark']['id']))?>
                        <div class="col-sm-8">
