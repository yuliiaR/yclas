...
<div class="pad_10tb">
	<div class="container">
		<div class="col-xs-12">
						...
						<?= FORM::open(Route::url('oc-panel',array('controller'=>'profile','action'=>'edit')), array('class'=>'form', 'enctype'=>'multipart/form-data'))?>
							...
							<div class="form-group clearfix">
								<div class="col-md-offset-4 col-md-8">
									<div class="checkbox">
										<label><input type="checkbox" name="subscriber" value="1" <?=($user->subscriber)?'checked':NULL?> > <?=__('Subscribed to emails')?></label>
									</div>
								</div>
							</div>
							<div class="form-group clearfix">
			...
			<div class="panel panel-default">
					<div class="panel-heading" id="page-edit-profile">
					<h3 class="panel-title"><?=__('Profile picture')?>
				...
				<div class="panel-body">
					<div class="clearfix">
						...
						<div class="col-sm-8 col-md-9 clearfix">
							<?= FORM::label('profile_img', __('Profile picture'), array('class'=>'col-xs-12 control-label', 'for'=>'profile_img'))?>
								<div class="col-sm-8">
