		...
		<div class="row">
			<div class="col-xs-12">
						...
						<li>
							<div class="panel panel-default">
								...
								<div class="panel-footer text-right">
									<a class="btn btn-default" title="<?=HTML::chars($faq->title)?>" href="<?=Route::url('faq', array('seotitle'=>$faq->seotitle))?>"><?=__('Read more')?>.</a>
								</div>
							</div>	
						</li>
					<?endforeach?>
				...
				<div class="no_results text-center">
					...
					<p class="nr_info"><?=__('We do not have any FAQ-s')?></p>
				</div>
